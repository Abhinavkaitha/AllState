...
rm(lista)
setwd("/Users/ARK/Desktop/DataScience/DataSets/Classification")
### read the all state purchase file 
allstate  = read.csv("/Users/ARK/Desktop/DataScience/DataSets/Classification/Purchase.csv")
...
test$QuoteConversion_Flag = ifelse(test$QuoteConversion_Flag == 1, 0,0)
...
summary(train)
#test-1=read.csv("/Users/ARK/Desktop/DataScience/DataSets/Classification/test.csv")
